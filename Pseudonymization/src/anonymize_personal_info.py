            ...
            if dict_names['tilltal_män'][0][i] in line.split(' '):
                if i not in dict_tilltal_man:
                    dict_tilltal_man[i] = (len(dict_tilltal_man.keys())+1, 
                                           dict_names['tilltal_män'][0][i],
                                           random.choice(dict_names['tilltal_män'][0]),
                                           random.choice(dict_names['tilltal_män'][0]),
                                           random.choice(dict_names['tilltal_män'][0])
                                          )
                else:
            ...
            if dict_names['förnamn_män'][0][i] in line.split(' '):
                if i not in dict_fornamn_man:
                    dict_fornamn_man[i] = (len(dict_fornamn_man.keys())+1,
                                           dict_names['förnamn_män'][0][i],
                                           random.choice(dict_names['förnamn_män'][0]),
                                           random.choice(dict_names['förnamn_män'][0]),
                                           random.choice(dict_names['förnamn_män'][0]),
            ...
            if dict_names['förnamn_kvinnor'][0][i] in line.split(' '):
                if i not in dict_fornamn_kvn:
                    dict_fornamn_kvn[i] = (len(dict_fornamn_kvn.keys())+1,
                                           dict_names['förnamn_kvinnor'][0][i],
                                           random.choice(dict_names['förnamn_kvinnor'][0]),
                                           random.choice(dict_names['förnamn_kvinnor'][0]),
                                           random.choice(dict_names['förnamn_kvinnor'][0]),
                                           random.choice(dict_names['efternamn'][0]),
                                           random.choice(dict_names['efternamn'][0]),
