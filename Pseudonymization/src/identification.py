...
#1111-11-11 //// 1111/11/11 //// 1111.11.11
        if re.search(r'\b(1|2)\d{3}-(0\d{1}|1(0|1|2))-(((0|1|2)\d{1})|(30|31))\b', line):  # Date 1111-11-11 as in yyyy-mm-dd
            line = re.sub(r'\b(1|2)\d{3}-(0\d{1}|1(0|1|2))-(((0|1|2)\d{1})|(30|31))\b', '1111-11-11/label/date_digits/label/'+str(indexing), line)
            indexing += 1
        if re.search(r'\b(1|2)\d{3}-(((0|1|2)\d{1})|(30|31))-(0\d{1}|1(0|1|2))\b', line):  # NEW Date 1111-11-11 as in yyyy-dd-mm
            line = re.sub(r'\b(1|2)\d{3}-(((0|1|2)\d{1})|(30|31))-(0\d{1}|1(0|1|2))\b', '1111-11-11/label/date_digits/label/'+str(indexing), line)
            indexing += 1
        if re.search(r'\b((1|2)\d{3}|\d{2})\/(0\d{1}|1(0|1|2))\/(((0|1|2)\d{1})|(30|31))\b', line):  # Date 1111/11/11 as in yyyy/mm/dd
            line = re.sub(r'\b((1|2)\d{3}|\d{2})\/(0\d{1}|1(0|1|2))\/(((0|1|2)\d{1})|(30|31))\b', '1111/11/11/label/date_digits/label/'+str(indexing), line)
            indexing += 1
        if re.search(r'\b(1|2)\d{3}\/(((0|1|2)\d{1})|(30|31))\/(0\d{1}|1(0|1|2))\b', line):  # TESTING 1111/11/11 as in  yyyy/dd/mm
            line = re.sub(r'\b(1|2)\d{3}\/(((0|1|2)\d{1})|(30|31))\/(0\d{1}|1(0|1|2))\b', '1111/11/11/label/date_digits/label/'+str(indexing), line)
            indexing += 1
        if re.search(r'\b(1|2)\d{3}\.(0\d{1}|1(0|1|2))\.(((0|1|2)\d{1})|(30|31))\b', line):  # Date 1111.11.11 as in yyyy.mm.dd
            line = re.sub(r'\b(1|2)\d{3}\.(0\d{1}|1(0|1|2))\.(((0|1|2)\d{1})|(30|31))\b', '1111.11.11/label/date_digits/label/'+str(indexing), line)
            indexing += 1
        if re.search(r'\b(1|2)\d{3}\.(((0|1|2)\d{1})|(30|31))\.(0\d{1}|1(0|1|2))\b', line):  # Date 1111.11.11 as in yyyy.dd.mm
            line = re.sub(r'\b(1|2)\d{3}\.(((0|1|2)\d{1})|(30|31))\.(0\d{1}|1(0|1|2))\b', '1111.11.11/label/date_digits/label/'+str(indexing), line)
            indexing += 1
#11-11-1111 //// 11/11/1111 //// 11.11.1111
        if re.search(r'\b(([1-9]|0[1-9]|[1-2][0-9]|3[0-1])-([1-9]|0[1-9]|1[0-2])-\d{4})\b', line):  # Date 11-11-1111 ---- NEW: as in dd-mm-yyyy
            line = re.sub(r'\b(([1-9]|0[1-9]|[1-2][0-9]|3[0-1])-([1-9]|0[1-9]|1[0-2])-\d{4})\b', '11-11-1111/label/date_digits/label/'+str(indexing), line)
            indexing += 1
        if re.search(r'\b(([1-9]|0[1-9]|1[0-2])-([1-9]|0[1-9]|[1-2][0-9]|3[0-1])-\d{4})\b', line):  # Date 11-11-1111 ---- NEW: as in mm-dd-yyyy
            line = re.sub(r'\b(([1-9]|0[1-9]|1[0-2])-([1-9]|0[1-9]|[1-2][0-9]|3[0-1])-\d{4})\b', '11-11-1111/label/date_digits/label/'+str(indexing), line)
            indexing += 1
        if re.search(r'\b(([1-9]|0[1-9]|[1-2][0-9]|3[0-1])\/([1-9]|0[1-9]|1[0-2])\/\d{4})\b', line):  # Date 11/11/1111 ---- NEW: as in dd/mm/yyyy
            line = re.sub(r'\b(([1-9]|0[1-9]|[1-2][0-9]|3[0-1])\/([1-9]|0[1-9]|1[0-2])\/\d{4})\b', '11/11/1111/label/date_digits/label/'+str(indexing), line)
            indexing += 1
...
#11-11-11 //// 11/11/11 //// 11.11.11         
        if re.search(r'\b(([1-9]|0[1-9]|[1-2][0-9]|3[0-1])\-([1-9]|0[1-9]|1[0-2])\-\d{2})\b', line):  # testing 11-11-11 as in dd-mm-yy
            line = re.sub(r'\b(([1-9]|0[1-9]|[1-2][0-9]|3[0-1])\-([1-9]|0[1-9]|1[0-2])\-\d{2})\b', '11-11-11/label/date_digits/label/'+str(indexing), line)
            indexing += 1
        if re.search(r'\b([1-9]|0[1-9]|1[0-2])\-(([1-9]|0[1-9]|[1-2][0-9]|3[0-1])\-\d{2})\b', line):  # testing 11-11-11 as in mm-dd-yy
