...
#1111-11-11 //// 1111/11/11 //// 1111.11.11
        if re.search(r'\b(1|2)\d{3}-(0\d{1}|1(0|1|2))-(((0|1|2)\d{1})|(30|31))\b', y):  # Date 1111-11-11 as in yyyy-mm-dd
            ...
            y = y
            z = z
        if re.search(r'\b(1|2)\d{3}-(((0|1|2)\d{1})|(30|31))-(0\d{1}|1(0|1|2))\b', y):  # NEW Date 1111-11-11 as in yyyy-dd-mm
            y = re.sub(r'\b(1|2)\d{3}-(((0|1|2)\d{1})|(30|31))-(0\d{1}|1(0|1|2))\b', '1111-11-11/label/date_digits/label/'+str(indexing), y)
            z = z
            indexing += 1
        else:
            y = y
            z = z       
        if re.search(r'\b((1|2)\d{3}|\d{2})\/(0\d{1}|1(0|1|2))\/(((0|1|2)\d{1})|(30|31))\b', y):  # Date 1111/11/11 as in yyyy/mm/dd
            y = re.sub(r'\b((1|2)\d{3}|\d{2})\/(0\d{1}|1(0|1|2))\/(((0|1|2)\d{1})|(30|31))\b', '1111/11/11/label/date_digits/label/'+str(indexing), y)
            z = z
            indexing += 1
        else:
            y = y
            z = z
        if re.search(r'\b(1|2)\d{3}\/(((0|1|2)\d{1})|(30|31))\/(0\d{1}|1(0|1|2))\b', y):  # TESTING 1111/11/11 as in yyyy/dd/mm
            y = re.sub(r'\b(1|2)\d{3}\/(((0|1|2)\d{1})|(30|31))\/(0\d{1}|1(0|1|2))\b', '1111/11/11/label/date_digits/label/'+str(indexing), y)
            z = z
            indexing += 1
        else:
        ...
        if re.search(r'\b(1|2)\d{3}\.(0\d{1}|1(0|1|2))\.(((0|1|2)\d{1})|(30|31))\b', y):  # Date 1111.11.11 as in yyyy.mm.dd
            ...
            y = y
            z = z
        if re.search(r'\b(1|2)\d{3}\.(((0|1|2)\d{1})|(30|31))\.(0\d{1}|1(0|1|2))\b', y):  # Date 1111.11.11 as in yyyy.dd.mm
            y = re.sub(r'\b(1|2)\d{3}\.(((0|1|2)\d{1})|(30|31))\.(0\d{1}|1(0|1|2))\b', '1111.11.11/label/date_digits/label/'+str(indexing), y)
            z = z
            indexing += 1
        else:
...
#11-11-1111 //// 11/11/1111 //// 11.11.1111
        if re.search(r'\b(([1-9]|0[1-9]|[1-2][0-9]|3[0-1])-([1-9]|0[1-9]|1[0-2])-\d{4})\b', y):  # Date 11-11-1111 -- NEW: as in dd-mm-yyyy
            y = re.sub(r'\b(([1-9]|0[1-9]|[1-2][0-9]|3[0-1])-([1-9]|0[1-9]|1[0-2])-\d{4})\b', '11-11-1111/label/date_digits/label/'+str(indexing), y)
            z = z
            indexing += 1
        else:
            y = y
            z = z
        if re.search(r'\b(([1-9]|0[1-9]|1[0-2])-([1-9]|0[1-9]|[1-2][0-9]|3[0-1])-\d{4})\b', y):  # Date 11-11-1111 -- NEW: as in mm-dd-yyyy
            y = re.sub(r'\b(([1-9]|0[1-9]|1[0-2])-([1-9]|0[1-9]|[1-2][0-9]|3[0-1])-\d{4})\b', '11-11-1111/label/date_digits/label/'+str(indexing), y)
            z = z
            indexing += 1
        else:
            y = y
...
#11-11-11 //// 11/11/11 //// 11.11.11
        if re.search(r'\b(([1-9]|0[1-9]|[1-2][0-9]|3[0-1])\-([1-9]|0[1-9]|1[0-2])\-\d{2})\b', y):  # testing 11-11-11 as in dd-mm-yy
            y = re.sub(r'\b(([1-9]|0[1-9]|[1-2][0-9]|3[0-1])\-([1-9]|0[1-9]|1[0-2])\-\d{2})\b', '11-11-11/label/date_digits/label/'+str(indexing), y)
            z = z
            indexing += 1
        else:
            y = y
            z = z
        if re.search(r'\b([1-9]|0[1-9]|1[0-2])\-(([1-9]|0[1-9]|[1-2][0-9]|3[0-1])\-\d{2})\b', y):  # testing 11-11-11 as in mm-dd-yy
            y = re.sub(r'\b([1-9]|0[1-9]|1[0-2])\-(([1-9]|0[1-9]|[1-2][0-9]|3[0-1])\-\d{2})\b', '11-11-11/label/date_digits/label/'+str(indexing), y)
            z = z
            indexing += 1
        else:
            y = y
...
#11-11 //// 11/11 //// 11.11
    ...
    for i in data:
        for j in set(list_countries):
            if ' ' in str(j):
                ...
                if str(j) in i[0].split(' ') and list_countries.index(str(j)) not in countries_in_data:
                    countries_in_data[list_countries.index(str(j))] = (j, countries_nr)
                    countries_nr += 1
    ...
    for i in data:
        for k in set(list_cities):
            if ' ' in str(k):
                ...
                if str(k) in i[0].split(' ') and list_cities.index(str(k)) not in cities_in_data and str(k) not in ['Man','Ta','Sedan','Fika','Hem','Forst','Seden','Utan']:
                    cities_in_data[list_cities.index(str(k))] = (k, cities_nr) 
                    cities_nr += 1
    ...
    for i in data:
        for j in set(swe_city):
            if ' ' in str(j):
                ...
                if str(j) in i[0].split(' ') and swe_city.index(str(j)) not in city_in_data:
                    city_in_data[swe_city.index(str(j))] = (j, city_nr)
                    city_nr += 1
    ...
    for i in data:
        for k in set(swe_street):
            if ' ' in str(k):
                ...
                if str(k) in i[0].split(' ') and swe_street.index(str(k)) not in street_in_data:
                    street_in_data[swe_street.index(str(k))] = (k, street_nr) 
                    street_nr += 1
    ...
    for line in data:
        for i in range(len(dict_names['förnamn_män'][0])):
            if dict_names['förnamn_män'][0][i][0] in line[0].split(' ') and dict_names['förnamn_män'][0][i][0] not in ['Den','Till','Just','Bonus','Ring','Stan','Mars']:
        ...
        for i in range(len(dict_names['neutral_namn'][0])):
            if dict_names['neutral_namn'][0][i][0] in line[0].split(' ') and dict_names['neutral_namn'][0][i][0] not in ['Men','Sen']:
        ...
        for i in range(len(dict_names['efternamn'][0])):
            if dict_names['efternamn'][0][i][0] in line[0].split(' ') and dict_names['efternamn'][0][i][0] not in ['När','Kram','Vad','Jaf','Först','Sund','Sist','Herr','Till','Just','Haga','Kramar','Fick','Sen','Tar','Ring','Stan','Land',]:
        ...
        for i in range(len(dict_names['förnamn_kvinnor'][0])):
            if dict_names['förnamn_kvinnor'][0][i][0] in line[0].split(' ') and dict_names['förnamn_kvinnor'][0][i][0] not in ['Har','Som','Haga','Andra']:
